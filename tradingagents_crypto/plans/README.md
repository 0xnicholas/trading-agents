...
| 阶段 | 周期 | 目标 | 交付物 |
|------|------|------|--------|
| **Phase 1** | 2-3 周 | Hyperliquid 单链打样 | 数据层 + 单 Agent + Graph 集成 |
| **Phase 2** | 2-3 周 | ETH / Solana 多链扩展 | 链上数据层 + 跨链 Macro Analyst |
| **Phase 3** | 2-3 周 | 风控 + 回测框架 | Risk Manager Agent + 规则回测引擎 |
